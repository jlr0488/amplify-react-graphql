...
//       image: image ? image.name : null, // Check if image exists before accessing 'name'
//     };
  
//     // Check if an image was provided before attempting to upload
//     if (image) {
//       await Amplify.Storage.put(data.name, image);
//     }
